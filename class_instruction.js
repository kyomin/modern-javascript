...
// [3]: ES5, ES6 --> 거치면서 --> 클래스 문법을 지원 --> 보다 편리하고 쉽게 OOP 문법을 구현할 수 있도록 지원
// 기존 프로토타입 기반의 OOP 문법이 없어지고, 새로운 Class 문법을 지원하는 것은 아니다!
...
class Person {
	...
	// testHello()
	testHello() {
		console.log(`안녕하세요~ ${this.name}(${this.age}) 회원님~`);
	}
}

...
// new 연산자를 사용해서 새로운 객체 생성 --> 만약 new를 안 붙이면 undefined 처리 --> 객체 생성 시에는 new 연산자를 꼭 사용!
...
function Person2(name, age) {
	// this = {}; <-- this라는 빈 객체를 하나 생성한 후에 속성 추가
	this.name = name;
	this.age = age;
	// return this;
}

// 정리: new 연산자를 사용하여 새로운 객체를 생성 시에는 생성자 함수 내부에서 위와 같은 처리로 새로운 객체가 생성

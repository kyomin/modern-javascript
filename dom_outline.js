...
// HTML 요소들의 구조화된 표현
// DOM 객체 구조는 '노트 트리'라고 표현. 부모 가지 --> 자식 가지(element) --> 잎
// 이러한 DOM 요소를 기반으로 브라우저가 해석하여 렌더링

/* ---------------------------------------- */

// [2]: 태그, 노드, 객체 --> 거의 같은 개념
// 자바스크립트를 이용하면 직접 이러한 노드를 추가하고, 삭제하는 등의 DOM 조작 작업을 할 수 있다. --> DOM을 배우는 궁극적인 이유!
// 즉, 손으로 직접 태그(노드)를 입력하지 않아도 태그를 body 태그 안에 추가시킬 수 있다.
